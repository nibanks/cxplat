...
//
typedef enum CXPLAT_PACKET_KEY_TYPE {

    CXPLAT_PACKET_KEY_INITIAL,
    CXPLAT_PACKET_KEY_0_RTT,
    CXPLAT_PACKET_KEY_HANDSHAKE,
    CXPLAT_PACKET_KEY_1_RTT,
    CXPLAT_PACKET_KEY_1_RTT_OLD,
    CXPLAT_PACKET_KEY_1_RTT_NEW,

    CXPLAT_PACKET_KEY_COUNT

} CXPLAT_PACKET_KEY_TYPE;

#pragma warning(disable:4200)  // nonstandard extension used: zero-length array in struct/union

typedef struct CXPLAT_PACKET_KEY {

    CXPLAT_PACKET_KEY_TYPE Type;
    CXPLAT_KEY* PacketKey;
    CXPLAT_HP_KEY* HeaderKey;
    uint8_t Iv[CXPLAT_IV_LENGTH];
    CXPLAT_SECRET TrafficSecret[0]; // Only preset for Type == CXPLAT_PACKET_KEY_1_RTT
...
inline
void
CxPlatCryptoCombineIvAndPacketNumber(
