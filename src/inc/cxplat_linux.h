...
#ifndef _MSCXPLAT_LINUX_
#define _MSCXPLAT_LINUX_
...
// as the value of CXPLAT_STATUS.
// In some situations, we use a custom value for CXPLAT_STATUS.
...
// There are static asserts to ensure that CXPLAT_STATUS type is large enough for
...
#define CXPLAT_STATUS_SUCCESS             ((CXPLAT_STATUS)ERROR_SUCCESS)
#define CXPLAT_STATUS_PENDING             ((CXPLAT_STATUS)ERROR_NOT_READY)
#define CXPLAT_STATUS_CONTINUE            ((CXPLAT_STATUS)ERROR_CONTINUE)
#define CXPLAT_STATUS_OUT_OF_MEMORY       ((CXPLAT_STATUS)ENOMEM)
#define CXPLAT_STATUS_INVALID_PARAMETER   ((CXPLAT_STATUS)EINVAL)
#define CXPLAT_STATUS_INVALID_STATE       ((CXPLAT_STATUS)ERROR_INVALID_STATE)
#define CXPLAT_STATUS_NOT_SUPPORTED       ((CXPLAT_STATUS)EOPNOTSUPP)
#define CXPLAT_STATUS_NOT_FOUND           ((CXPLAT_STATUS)ENOENT)
#define CXPLAT_STATUS_BUFFER_TOO_SMALL    ((CXPLAT_STATUS)EOVERFLOW)
#define CXPLAT_STATUS_HANDSHAKE_FAILURE   ((CXPLAT_STATUS)ERROR_HANDSHAKE_FAILURE)
#define CXPLAT_STATUS_ABORTED             ((CXPLAT_STATUS)ERROR_OPERATION_ABORTED)
#define CXPLAT_STATUS_ADDRESS_IN_USE      ((CXPLAT_STATUS)EADDRINUSE)
#define CXPLAT_STATUS_CONNECTION_TIMEOUT  ((CXPLAT_STATUS)ETIMEDOUT)
#define CXPLAT_STATUS_CONNECTION_IDLE     ((CXPLAT_STATUS)ERROR_CONNECTION_IDLE)
#define CXPLAT_STATUS_INTERNAL_ERROR      ((CXPLAT_STATUS)ERROR_INTERNAL_ERROR)
#define CXPLAT_STATUS_CONNECTION_REFUSED  ((CXPLAT_STATUS)ERROR_CONNECTION_REFUSED)
#define CXPLAT_STATUS_PROTOCOL_ERROR      ((CXPLAT_STATUS)ERROR_PROTOCOL_ERROR)
#define CXPLAT_STATUS_VER_NEG_ERROR       ((CXPLAT_STATUS)ERROR_VER_NEG_ERROR)
#define CXPLAT_STATUS_UNREACHABLE         ((CXPLAT_STATUS)EHOSTUNREACH)
#define CXPLAT_STATUS_PERMISSION_DENIED   ((CXPLAT_STATUS)EPERM)
#define CXPLAT_STATUS_EPOLL_ERROR         ((CXPLAT_STATUS)ERROR_EPOLL_ERROR)
#define CXPLAT_STATUS_DNS_RESOLUTION_ERROR ((CXPLAT_STATUS)ERROR_DNS_RESOLUTION_ERROR)
#define CXPLAT_STATUS_SOCKET_ERROR        ((CXPLAT_STATUS)ERROR_SOCKET_ERROR)
#define CXPLAT_STATUS_TLS_ERROR           ((CXPLAT_STATUS)ERROR_SSL_ERROR)
#define CXPLAT_STATUS_USER_CANCELED       ((CXPLAT_STATUS)ERROR_USER_CANCELED)
#define CXPLAT_STATUS_ALPN_NEG_FAILURE    ((CXPLAT_STATUS)ERROR_ALPN_NEG_FAILURE)

typedef unsigned char BOOLEAN;
typedef struct in_addr IN_ADDR;
typedef struct in6_addr IN6_ADDR;
typedef struct addrinfo ADDRINFO;
typedef sa_family_t CXPLAT_ADDRESS_FAMILY;
...
#define CXPLAT_ADDR_V4_PORT_OFFSET        FIELD_OFFSET(struct sockaddr_in, sin_port)
#define CXPLAT_ADDR_V4_IP_OFFSET          FIELD_OFFSET(struct sockaddr_in, sin_addr)

#define CXPLAT_ADDR_V6_PORT_OFFSET        FIELD_OFFSET(struct sockaddr_in6, sin6_port)
#define CXPLAT_ADDR_V6_IP_OFFSET          FIELD_OFFSET(struct sockaddr_in6, sin6_addr)
...
#define INITCODE
#define PAGEDX
#define CXPLAT_CACHEALIGN

#if defined(__cplusplus)
extern "C" {
#endif

#define CXPLAT_LOCALHOST_FOR_AF(Af) ((Af == CXPLAT_ADDRESS_FAMILY_INET) ? "localhost" : "ip6-localhost")

#define CXPLAT_CERTIFICATE_FLAG_IGNORE_REVOCATION                 0x00000080
#define CXPLAT_CERTIFICATE_FLAG_IGNORE_UNKNOWN_CA                 0x00000100
#define CXPLAT_CERTIFICATE_FLAG_IGNORE_WRONG_USAGE                0x00000200
#define CXPLAT_CERTIFICATE_FLAG_IGNORE_CERTIFICATE_CN_INVALID     0x00001000 // bad common name in X509 Cert.
#define CXPLAT_CERTIFICATE_FLAG_IGNORE_CERTIFICATE_DATE_INVALID   0x00002000 // expired X509 Cert.
#define CXPLAT_CERTIFICATE_FLAG_IGNORE_WEAK_SIGNATURE             0x00010000
...
{
    return
        Family == CXPLAT_ADDRESS_FAMILY_UNSPEC ||
        Family == CXPLAT_ADDRESS_FAMILY_INET ||
        Family == CXPLAT_ADDRESS_FAMILY_INET6;
}
...
{
    if (CXPLAT_ADDRESS_FAMILY_INET == Addr1->Ip.sa_family) {
...
{
    if (CXPLAT_ADDRESS_FAMILY_INET == Addr->Ip.sa_family) {
...
{
    if (Addr->Ip.sa_family == CXPLAT_ADDRESS_FAMILY_INET) {
...
{
    if (Addr->Ip.sa_family == CXPLAT_ADDRESS_FAMILY_UNSPEC) {
        return TRUE;
    } else if (Addr->Ip.sa_family == CXPLAT_ADDRESS_FAMILY_INET) {
    ...
    )
{
    ...
    Addr->Ip.sa_family = CXPLAT_ADDRESS_FAMILY_INET;
    return TRUE;
}
    ...
    )
{
    ...
    Addr->Ip.sa_family = CXPLAT_ADDRESS_FAMILY_INET6;
    return TRUE;
}
    ...
    )
{
    ...
    if (Addr->Ip.sa_family == CXPLAT_ADDRESS_FAMILY_INET6 && Addr->Ipv6.sin6_port != 0) {
        Address[0] = '[';
        Address++;
    }
    if (inet_ntop(
            ...
            &Addr->Ipv4.sin_addr,
            Address,
            sizeof(CXPLAT_ADDR_STR)) == NULL) {
        return FALSE;
    }
    if (Addr->Ipv4.sin_port != 0) {
        Address += strlen(Address);
        if (Addr->Ip.sa_family == CXPLAT_ADDRESS_FAMILY_INET6) {
            Address[0] = ']';
            Address++;
        }
